...
//
{
  ...
  Figlet::standard.print("oneMD");
	try {  
    CmdLine cmd("oneMD data-parallel molecular dynamics simulator.", ' ', "0.1");
    UnlabeledValueArg<string>  simArg("simulator","Name of simulator to run.",true,"cpu","string", cmd);
    UnlabeledValueArg<int> dimsArg("dimensions","Number of dimensions for simulation from 1 - 3.",true, 1,"integer", cmd);
